...
p_palettes_custom <- ct_palette_show(c(
  "#264653",
  "#2A9D8F",
  "#E9C46A",
  "#F4A261",
...
p_pal_navy <- base_sectors() +
  scale_color_ct("strategy_navy") +
  labs(title = "strategy_navy")
p_pal_emerald <- base_sectors() +
  scale_color_ct("strategy_emerald") +
  labs(title = "strategy_emerald")
p_pal_crimson <- base_sectors() +
  scale_color_ct("strategy_crimson") +
  labs(title = "strategy_crimson")
p_pal_azure <- base_sectors() +
